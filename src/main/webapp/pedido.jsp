...
<head>
    ...
    <script>
        function validarPedido() {
            var camposQuantidade = document.querySelectorAll('input[name^="quantidade"]');
...
<div align="center" class="container">
    <form action="pedido" method="post" class="pedido" onsubmit="return validarPedido()">
        <p class="title">
        ...
        <table>
            ...
            <tr>
                <td class="aluno" colspan="4">
                    <p class="title">Código Reserva:</p> <input class="cadastro" type="number"
                                                          id="codigoReserva" name="codigoReserva" placeholder=""
                                                          value='<c:out value="${reserva.codigo }"></c:out>'>
                </td>
            </tr>
    <tr class="botoes2">
    <td colspan="5" style="text-align: center;">
            <input type="submit" id="botaoListarPedidos" name="botao" value="Listar Itens">
            <input type="submit" id="botaoListar" name="botao" value="Listar">
            <input type="submit" id="botaoCadastrar" name="botao" value="Cadastrar">
    </td>
    </tr>
    <tr class="botoes3">
    <td colspan="5" style="text-align: center;">
            <input type="submit" id="botaoReservar" name="botao" value="Reservar">
            <input type="submit" id="botaoListarReservas" name="botao" value="Listar Reservas">
    </td>
    </tr>
        </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="pedido" method="post"
                                ...
                                <input type="hidden" name="produtoCodigo"
